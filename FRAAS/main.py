...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vaishnavnegi207@gmail.com' ")
...
window.title("F.R.A.A.S.")
window.configure(background='SlateBlue3')

frame1 = tk.Frame(window, bg="#00aeff")
frame1.place(relx=0.115, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#00aeff")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="***AUTOMATED ATTENDANCE SYSTEM***" ,fg="gold",bg="SlateBlue2" ,width=45 ,height=1,font=('times', 29, ' bold '))
message3.place(relx=0.12, rely=0.01)

frame3 = tk.Frame(window, bg="#c4c6ce")
frame3.place(relx=0.42, rely=0.09, relwidth=0.16, relheight=0.07)

datef = tk.Label(frame3, text = day+"-"+mont[month]+"-"+year, fg="orange",bg="#262523" ,width=100 ,height=1,font=('times', 22, ' bold '))
